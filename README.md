...
- Используются разные автоматического реферирования, начисляющие предложениям "индексы значимости"
- Эти методы берутся отсюда: https://tconspectus.pythonanywhere.com/about#algorithm
- Программа требует установки библиотек nltk и libpdf, а также использует модули 
- -re, math, pandas, libpdf из одноименной библиотеки
